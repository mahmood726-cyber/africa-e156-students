#!/usr/bin/env python3
"""
Francophone Research Desert — Africa E156 Student Analysis
Group: geographic-equity | Paper #24

Condition: all interventional
Location: Africa

This standalone script demonstrates the statistical methods used in this paper.
Run: python francophone-research-desert.py
"""
...
def main():
    print("=" * 60)
    print(f"  {'Francophone Research Desert'}")
    ...
    country_values = [215, 183, 113, 55, 44, 35, 14, 0]
