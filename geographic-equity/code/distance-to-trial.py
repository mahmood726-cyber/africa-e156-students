#!/usr/bin/env python3
"""
Distance-to-Trial-Site Burden — Africa E156 Student Analysis
Group: geographic-equity | Paper #31

Condition: all interventional
Location: Africa

This standalone script demonstrates the statistical methods used in this paper.
Run: python distance-to-trial.py
"""
...
def main():
    print("=" * 60)
    print(f"  {'Distance-to-Trial-Site Burden'}")
