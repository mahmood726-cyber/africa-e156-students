#!/usr/bin/env python3
"""
Southern African Research Arc — Africa E156 Student Analysis
Group: geographic-equity | Paper #29

Condition: all interventional
Location: Africa

This standalone script demonstrates the statistical methods used in this paper.
Run: python southern-african-arc.py
"""
...
def main():
    print("=" * 60)
    print(f"  {'Southern African Research Arc'}")
    ...
    country_values = [3654, 460, 344, 307, 201, 147, 123, 106]
