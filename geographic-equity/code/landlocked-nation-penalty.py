#!/usr/bin/env python3
"""
Landlocked Nation Penalty — Africa E156 Student Analysis
Group: geographic-equity | Paper #21

Condition: all interventional
Location: Africa

This standalone script demonstrates the statistical methods used in this paper.
Run: python landlocked-nation-penalty.py
"""
...
def main():
    print("=" * 60)
    print(f"  {'Landlocked Nation Penalty'}")
    ...
    country_values = [809, 344, 307, 302, 215, 201, 183, 138, 123, 44]
