#!/usr/bin/env python3
"""
Gender in Trial Leadership — Africa E156 Student Analysis
Group: governance-justice | Paper #23

Condition: all interventional
Location: Africa

This standalone script demonstrates the statistical methods used in this paper.
Run: python gender-trial-leadership.py
"""
...
def main():
    print("=" * 60)
    print(f"  {'Gender in Trial Leadership'}")
