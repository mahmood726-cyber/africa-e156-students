#!/usr/bin/env python3
"""
Informed Consent Language Audit — Africa E156 Student Analysis
Group: governance-justice | Paper #21

Condition: all interventional
Location: Africa

This standalone script demonstrates the statistical methods used in this paper.
Run: python informed-consent-language.py
"""
...
def main():
    print("=" * 60)
    print(f"  {'Informed Consent Language Audit'}")
