#!/usr/bin/env python3
"""
Community Engagement Depth — Africa E156 Student Analysis
Group: governance-justice | Paper #30

Condition: all interventional
Location: Africa

This standalone script demonstrates the statistical methods used in this paper.
Run: python community-engagement-depth.py
"""
...
def fetch_trial_count(condition=None, location=None, other=None):
    ...
    params["query.term"] = "community engagement OR community advisory"
    try:
...
def main():
    print("=" * 60)
    print(f"  {'Community Engagement Depth'}")
