#!/usr/bin/env python3
"""
Local Manufacturing Capacity — Africa E156 Student Analysis
Group: governance-justice | Paper #39

Condition: all interventional
Location: Africa

This standalone script demonstrates the statistical methods used in this paper.
Run: python local-manufacturing.py
"""
...
def fetch_trial_count(condition=None, location=None, other=None):
    ...
    params["query.term"] = "locally manufactured OR local production"
    try:
...
def main():
    print("=" * 60)
    print(f"  {'Local Manufacturing Capacity'}")
