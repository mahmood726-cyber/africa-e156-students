#!/usr/bin/env python3
"""
South-South Collaboration Index — Africa E156 Student Analysis
Group: governance-justice | Paper #27

Condition: all interventional
Location: Africa

This standalone script demonstrates the statistical methods used in this paper.
Run: python south-south-collaboration.py
"""
...
def fetch_trial_count(condition=None, location=None, other=None):
    ...
    params["query.term"] = "India OR China OR Brazil"
    try:
...
def main():
    print("=" * 60)
    print(f"  {'South-South Collaboration Index'}")
