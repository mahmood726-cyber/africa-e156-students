#!/usr/bin/env python3
"""
Health Economic Evaluation — Africa E156 Student Analysis
Group: methods-systems | Paper #41

Condition: all interventional
Location: Africa

This standalone script demonstrates the statistical methods used in this paper.
Run: python health-economic-evaluation.py
"""
...
def fetch_trial_count(condition=None, location=None, other=None):
    ...
    params["query.term"] = "cost-effectiveness OR economic evaluation OR health economics"
    try:
...
def main():
    print("=" * 60)
    print(f"  {'Health Economic Evaluation'}")
