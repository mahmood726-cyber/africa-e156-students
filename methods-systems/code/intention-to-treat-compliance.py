#!/usr/bin/env python3
"""
Intention-to-Treat Compliance — Africa E156 Student Analysis
Group: methods-systems | Paper #34

Condition: all interventional
Location: Africa

This standalone script demonstrates the statistical methods used in this paper.
Run: python intention-to-treat-compliance.py
"""
...
def main():
    print("=" * 60)
    print(f"  {'Intention-to-Treat Compliance'}")
