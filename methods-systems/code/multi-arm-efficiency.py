#!/usr/bin/env python3
"""
Multi-Arm Trial Efficiency — Africa E156 Student Analysis
Group: methods-systems | Paper #36

Condition: all interventional
Location: Africa

This standalone script demonstrates the statistical methods used in this paper.
Run: python multi-arm-efficiency.py
"""
...
def fetch_trial_count(condition=None, location=None, other=None):
    ...
    params["query.term"] = "multi-arm OR multiple arm"
    try:
...
def main():
    print("=" * 60)
    print(f"  {'Multi-Arm Trial Efficiency'}")
