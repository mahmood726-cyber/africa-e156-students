#!/usr/bin/env python3
"""
Long-Term Follow-Up Deficit — Africa E156 Student Analysis
Group: methods-systems | Paper #42

Condition: all interventional
Location: Africa

This standalone script demonstrates the statistical methods used in this paper.
Run: python long-term-followup.py
"""
...
def main():
    print("=" * 60)
    print(f"  {'Long-Term Follow-Up Deficit'}")
