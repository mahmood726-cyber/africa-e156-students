#!/usr/bin/env python3
"""
Adaptive Design Adoption Curve — Africa E156 Student Analysis
Group: methods-systems | Paper #21

Condition: all interventional
Location: Africa

This standalone script demonstrates the statistical methods used in this paper.
Run: python adaptive-design-adoption.py
"""
...
def fetch_trial_count(condition=None, location=None, other=None):
    ...
    params["query.term"] = "adaptive design OR adaptive trial"
    try:
...
def main():
    print("=" * 60)
    print(f"  {'Adaptive Design Adoption Curve'}")
