#!/usr/bin/env python3
"""
Implementation Science Penetration — Africa E156 Student Analysis
Group: methods-systems | Paper #40

Condition: all interventional
Location: Africa

This standalone script demonstrates the statistical methods used in this paper.
Run: python implementation-science.py
"""
...
def fetch_trial_count(condition=None, location=None, other=None):
    ...
    params["query.term"] = "implementation science OR implementation research"
    try:
...
def main():
    print("=" * 60)
    print(f"  {'Implementation Science Penetration'}")
