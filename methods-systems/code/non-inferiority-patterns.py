#!/usr/bin/env python3
"""
Non-Inferiority Design Patterns — Africa E156 Student Analysis
Group: methods-systems | Paper #38

Condition: all interventional
Location: Africa

This standalone script demonstrates the statistical methods used in this paper.
Run: python non-inferiority-patterns.py
"""
...
def fetch_trial_count(condition=None, location=None, other=None):
    ...
    params["query.term"] = "non-inferiority OR equivalence"
    try:
...
def main():
    print("=" * 60)
    print(f"  {'Non-Inferiority Design Patterns'}")
