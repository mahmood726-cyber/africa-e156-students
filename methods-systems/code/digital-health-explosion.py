#!/usr/bin/env python3
"""
Digital Health Trial Explosion — Africa E156 Student Analysis
Group: methods-systems | Paper #25

Condition: all interventional
Location: Africa

This standalone script demonstrates the statistical methods used in this paper.
Run: python digital-health-explosion.py
"""
...
def fetch_trial_count(condition=None, location=None, other=None):
    ...
    params["query.term"] = "mHealth OR telemedicine OR digital health OR mobile health"
    try:
...
def main():
    print("=" * 60)
    print(f"  {'Digital Health Trial Explosion'}")
