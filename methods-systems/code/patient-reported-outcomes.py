#!/usr/bin/env python3
"""
Patient-Reported Outcomes Gap — Africa E156 Student Analysis
Group: methods-systems | Paper #29

Condition: all interventional
Location: Africa

This standalone script demonstrates the statistical methods used in this paper.
Run: python patient-reported-outcomes.py
"""
...
def fetch_trial_count(condition=None, location=None, other=None):
    ...
    params["query.term"] = "patient reported outcome OR quality of life OR PRO"
    try:
...
def main():
    print("=" * 60)
    print(f"  {'Patient-Reported Outcomes Gap'}")
