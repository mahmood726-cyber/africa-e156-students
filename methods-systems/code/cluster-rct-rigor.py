#!/usr/bin/env python3
"""
Cluster-RCT Design Rigor — Africa E156 Student Analysis
Group: methods-systems | Paper #37

Condition: all interventional
Location: Africa

This standalone script demonstrates the statistical methods used in this paper.
Run: python cluster-rct-rigor.py
"""
...
def fetch_trial_count(condition=None, location=None, other=None):
    ...
    params["query.term"] = "cluster randomized OR cluster randomised"
    try:
...
def main():
    print("=" * 60)
    print(f"  {'Cluster-RCT Design Rigor'}")
