#!/usr/bin/env python3
"""
Platform Trial Readiness — Africa E156 Student Analysis
Group: methods-systems | Paper #22

Condition: all interventional
Location: Africa

This standalone script demonstrates the statistical methods used in this paper.
Run: python platform-trial-readiness.py
"""
...
def fetch_trial_count(condition=None, location=None, other=None):
    ...
    params["query.term"] = "platform trial OR master protocol OR basket"
    try:
...
def main():
    print("=" * 60)
    print(f"  {'Platform Trial Readiness'}")
