#!/usr/bin/env python3
"""
Pragmatic vs Explanatory Spectrum — Africa E156 Student Analysis
Group: methods-systems | Paper #24

Condition: all interventional
Location: Africa

This standalone script demonstrates the statistical methods used in this paper.
Run: python pragmatic-explanatory-spectrum.py
"""
...
def main():
    print("=" * 60)
    print(f"  {'Pragmatic vs Explanatory Spectrum'}")
