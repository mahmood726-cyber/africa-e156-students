#!/usr/bin/env python3
"""
Cervical Cancer HPV Gap — Africa E156 Student Analysis
Group: health-disease | Paper #30

Condition: cervical cancer OR HPV
Location: Africa

This standalone script demonstrates the statistical methods used in this paper.
Run: python cervical-cancer-hpv.py
"""
...
def fetch_trial_count(condition=None, location=None, other=None):
    ...
    params["query.cond"] = "cervical cancer OR HPV"
...
def main():
    print("=" * 60)
    print(f"  {'Cervical Cancer HPV Gap'}")
