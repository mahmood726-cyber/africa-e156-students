#!/usr/bin/env python3
"""
Tuberculosis Co-Infection Gap — Africa E156 Student Analysis
Group: health-disease | Paper #22

Condition: tuberculosis
Location: Africa

This standalone script demonstrates the statistical methods used in this paper.
Run: python tb-coinfection-gap.py
"""
...
def fetch_trial_count(condition=None, location=None, other=None):
    ...
    params["query.cond"] = "tuberculosis"
...
def main():
    print("=" * 60)
    print(f"  {'Tuberculosis Co-Infection Gap'}")
