#!/usr/bin/env python3
"""
Road Traffic Injury Trials — Africa E156 Student Analysis
Group: health-disease | Paper #53

Condition: trauma OR road traffic injury OR emergency medicine
Location: Africa

This standalone script demonstrates the statistical methods used in this paper.
Run: python road-traffic-injury.py
"""
...
def fetch_trial_count(condition=None, location=None, other=None):
    ...
    params["query.cond"] = "trauma OR road traffic injury OR emergency medicine"
...
def main():
    print("=" * 60)
    print(f"  {'Road Traffic Injury Trials'}")
