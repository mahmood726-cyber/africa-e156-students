#!/usr/bin/env python3
"""
Schistosomiasis Pipeline — Africa E156 Student Analysis
Group: health-disease | Paper #36

Condition: schistosomiasis OR bilharzia
Location: Africa

This standalone script demonstrates the statistical methods used in this paper.
Run: python schistosomiasis-pipeline.py
"""
...
def fetch_trial_count(condition=None, location=None, other=None):
    ...
    params["query.cond"] = "schistosomiasis OR bilharzia"
...
def main():
    print("=" * 60)
    print(f"  {'Schistosomiasis Pipeline'}")
