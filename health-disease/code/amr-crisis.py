#!/usr/bin/env python3
"""
Antimicrobial Resistance Crisis — Africa E156 Student Analysis
Group: health-disease | Paper #38

Condition: antimicrobial resistance OR antibiotic resistance OR AMR
Location: Africa

This standalone script demonstrates the statistical methods used in this paper.
Run: python amr-crisis.py
"""
...
def fetch_trial_count(condition=None, location=None, other=None):
    ...
    params["query.cond"] = "antimicrobial resistance OR antibiotic resistance OR AMR"
...
def main():
    print("=" * 60)
    print(f"  {'Antimicrobial Resistance Crisis'}")
