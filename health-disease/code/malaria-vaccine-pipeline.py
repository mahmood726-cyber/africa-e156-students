#!/usr/bin/env python3
"""
Malaria Vaccine Pipeline — Africa E156 Student Analysis
Group: health-disease | Paper #23

Condition: malaria vaccine
Location: Africa

This standalone script demonstrates the statistical methods used in this paper.
Run: python malaria-vaccine-pipeline.py
"""
...
def fetch_trial_count(condition=None, location=None, other=None):
    ...
    params["query.cond"] = "malaria vaccine"
...
def main():
    print("=" * 60)
    print(f"  {'Malaria Vaccine Pipeline'}")
