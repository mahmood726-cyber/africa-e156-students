#!/usr/bin/env python3
"""
Substance Use Disorders — Africa E156 Student Analysis
Group: health-disease | Paper #54

Condition: alcohol OR tobacco OR substance use OR addiction
Location: Africa

This standalone script demonstrates the statistical methods used in this paper.
Run: python substance-use-disorders.py
"""
...
def fetch_trial_count(condition=None, location=None, other=None):
    ...
    params["query.cond"] = "alcohol OR tobacco OR substance use OR addiction"
...
def main():
    print("=" * 60)
    print(f"  {'Substance Use Disorders'}")
