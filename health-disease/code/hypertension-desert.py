#!/usr/bin/env python3
"""
Hypertension Trial Desert — Africa E156 Student Analysis
Group: health-disease | Paper #26

Condition: hypertension
Location: Africa

This standalone script demonstrates the statistical methods used in this paper.
Run: python hypertension-desert.py
"""
...
def fetch_trial_count(condition=None, location=None, other=None):
    ...
    params["query.cond"] = "hypertension"
...
def main():
    print("=" * 60)
    print(f"  {'Hypertension Trial Desert'}")
