#!/usr/bin/env python3
"""
Respiratory Infection Pipeline — Africa E156 Student Analysis
Group: health-disease | Paper #44

Condition: pneumonia OR lower respiratory infection
Location: Africa

This standalone script demonstrates the statistical methods used in this paper.
Run: python respiratory-infection.py
"""
...
def fetch_trial_count(condition=None, location=None, other=None):
    ...
    params["query.cond"] = "pneumonia OR lower respiratory infection"
...
def main():
    print("=" * 60)
    print(f"  {'Respiratory Infection Pipeline'}")
