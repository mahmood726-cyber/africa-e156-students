#!/usr/bin/env python3
"""
Surgical Trials Void — Africa E156 Student Analysis
Group: health-disease | Paper #49

Condition: surgery OR surgical OR anesthesia
Location: Africa

This standalone script demonstrates the statistical methods used in this paper.
Run: python surgical-trials-void.py
"""
...
def fetch_trial_count(condition=None, location=None, other=None):
    ...
    params["query.cond"] = "surgery OR surgical OR anesthesia"
    params["query.locn"] = "Africa"
    params["query.term"] = "INTERVENTIONAL"
    try:
