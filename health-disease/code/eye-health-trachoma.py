#!/usr/bin/env python3
"""
Eye Health & Trachoma — Africa E156 Student Analysis
Group: health-disease | Paper #48

Condition: trachoma OR ophthalmology OR blindness OR cataract
Location: Africa

This standalone script demonstrates the statistical methods used in this paper.
Run: python eye-health-trachoma.py
"""
...
def fetch_trial_count(condition=None, location=None, other=None):
    ...
    params["query.cond"] = "trachoma OR ophthalmology OR blindness OR cataract"
