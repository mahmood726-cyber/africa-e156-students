#!/usr/bin/env python3
"""
Neonatal Mortality Gap — Africa E156 Student Analysis
Group: health-disease | Paper #42

Condition: neonatal OR newborn
Location: Africa

This standalone script demonstrates the statistical methods used in this paper.
Run: python neonatal-mortality-gap.py
"""
...
def fetch_trial_count(condition=None, location=None, other=None):
    ...
    params["query.cond"] = "neonatal OR newborn"
...
def main():
    print("=" * 60)
    print(f"  {'Neonatal Mortality Gap'}")
