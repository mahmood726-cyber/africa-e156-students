#!/usr/bin/env python3
"""
Epilepsy Treatment Gap — Africa E156 Student Analysis
Group: health-disease | Paper #34

Condition: epilepsy OR seizure
Location: Africa

This standalone script demonstrates the statistical methods used in this paper.
Run: python epilepsy-treatment-gap.py
"""
...
def fetch_trial_count(condition=None, location=None, other=None):
    ...
    params["query.cond"] = "epilepsy OR seizure"
...
def main():
    print("=" * 60)
    print(f"  {'Epilepsy Treatment Gap'}")
