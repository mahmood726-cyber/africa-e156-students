#!/usr/bin/env python3
"""
Childhood Cancer Neglect — Africa E156 Student Analysis
Group: health-disease | Paper #32

Condition: pediatric cancer OR childhood cancer
Location: Africa

This standalone script demonstrates the statistical methods used in this paper.
Run: python childhood-cancer-neglect.py
"""
...
def fetch_trial_count(condition=None, location=None, other=None):
    ...
    params["query.cond"] = "pediatric cancer OR childhood cancer"
...
def main():
    print("=" * 60)
    print(f"  {'Childhood Cancer Neglect'}")
