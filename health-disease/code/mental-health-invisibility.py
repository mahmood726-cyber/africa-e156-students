#!/usr/bin/env python3
"""
Mental Health Invisibility — Africa E156 Student Analysis
Group: health-disease | Paper #33

Condition: depression OR anxiety OR psychosis OR mental health
Location: Africa

This standalone script demonstrates the statistical methods used in this paper.
Run: python mental-health-invisibility.py
"""
...
def fetch_trial_count(condition=None, location=None, other=None):
    ...
    params["query.cond"] = "depression OR anxiety OR psychosis OR mental health"
...
def main():
    print("=" * 60)
    print(f"  {'Mental Health Invisibility'}")
