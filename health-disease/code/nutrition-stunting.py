#!/usr/bin/env python3
"""
Nutrition & Stunting Trials — Africa E156 Student Analysis
Group: health-disease | Paper #43

Condition: malnutrition OR stunting OR wasting OR nutrition
Location: Africa

This standalone script demonstrates the statistical methods used in this paper.
Run: python nutrition-stunting.py
"""
...
def fetch_trial_count(condition=None, location=None, other=None):
    ...
    params["query.cond"] = "malnutrition OR stunting OR wasting OR nutrition"
...
def main():
    print("=" * 60)
    print(f"  {'Nutrition & Stunting Trials'}")
