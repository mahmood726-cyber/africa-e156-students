#!/usr/bin/env python3
"""
Neglected Tropical Diseases Atlas — Africa E156 Student Analysis
Group: health-disease | Paper #35

Condition: neglected tropical disease OR NTD OR schistosomiasis OR onchocerciasis OR lymphatic filariasis
Location: Africa

This standalone script demonstrates the statistical methods used in this paper.
Run: python ntd-atlas.py
"""
...
def fetch_trial_count(condition=None, location=None, other=None):
    ...
    params["query.cond"] = "neglected tropical disease OR NTD OR schistosomiasis OR onchocerciasis OR lymphatic filariasis"
...
def main():
    print("=" * 60)
    print(f"  {'Neglected Tropical Diseases Atlas'}")
