#!/usr/bin/env python3
"""
Rheumatic Heart Disease — Africa E156 Student Analysis
Group: health-disease | Paper #52

Condition: rheumatic heart disease OR rheumatic fever
Location: Africa

This standalone script demonstrates the statistical methods used in this paper.
Run: python rheumatic-heart-disease.py
"""
...
def fetch_trial_count(condition=None, location=None, other=None):
    ...
    params["query.cond"] = "rheumatic heart disease OR rheumatic fever"
...
def main():
    print("=" * 60)
    print(f"  {'Rheumatic Heart Disease'}")
