#!/usr/bin/env python3
"""
Prostate Cancer Genomic Divide — Africa E156 Student Analysis
Group: health-disease | Paper #31

Condition: prostate cancer
Location: Africa

This standalone script demonstrates the statistical methods used in this paper.
Run: python prostate-cancer-genomic.py
"""
...
def fetch_trial_count(condition=None, location=None, other=None):
    ...
    params["query.cond"] = "prostate cancer"
...
def main():
    print("=" * 60)
    print(f"  {'Prostate Cancer Genomic Divide'}")
