#!/usr/bin/env python3
"""
Liver Disease & Hepatitis B — Africa E156 Student Analysis
Group: health-disease | Paper #47

Condition: hepatitis B OR hepatitis C OR liver disease
Location: Africa

This standalone script demonstrates the statistical methods used in this paper.
Run: python liver-hepatitis-b.py
"""
...
def fetch_trial_count(condition=None, location=None, other=None):
    ...
    params["query.cond"] = "hepatitis B OR hepatitis C OR liver disease"
...
def main():
    print("=" * 60)
    print(f"  {'Liver Disease & Hepatitis B'}")
