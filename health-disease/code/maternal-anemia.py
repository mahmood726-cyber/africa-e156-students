#!/usr/bin/env python3
"""
Maternal Anemia Pipeline — Africa E156 Student Analysis
Group: health-disease | Paper #55

Condition: anemia AND pregnancy OR iron supplementation
Location: Africa

This standalone script demonstrates the statistical methods used in this paper.
Run: python maternal-anemia.py
"""
...
def fetch_trial_count(condition=None, location=None, other=None):
    ...
    params["query.cond"] = "anemia AND pregnancy OR iron supplementation"
...
def main():
    print("=" * 60)
    print(f"  {'Maternal Anemia Pipeline'}")
