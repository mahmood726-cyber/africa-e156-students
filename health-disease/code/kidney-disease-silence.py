#!/usr/bin/env python3
"""
Kidney Disease Silence — Africa E156 Student Analysis
Group: health-disease | Paper #46

Condition: chronic kidney disease OR acute kidney injury OR nephrology
Location: Africa

This standalone script demonstrates the statistical methods used in this paper.
Run: python kidney-disease-silence.py
"""
...
def fetch_trial_count(condition=None, location=None, other=None):
    ...
    params["query.cond"] = "chronic kidney disease OR acute kidney injury OR nephrology"
...
def main():
    print("=" * 60)
    print(f"  {'Kidney Disease Silence'}")
    ...
    print(f"KM median survival time: {curve[len(curve)//2][0]}")
