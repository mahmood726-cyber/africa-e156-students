#!/usr/bin/env python3
"""
Aging & Geriatric Medicine — Africa E156 Student Analysis
Group: health-disease | Paper #59

Condition: elderly OR geriatric OR aging
Location: Africa

This standalone script demonstrates the statistical methods used in this paper.
Run: python aging-geriatric.py
"""
...
def fetch_trial_count(condition=None, location=None, other=None):
    ...
    params["query.cond"] = "elderly OR geriatric OR aging"
...
def main():
    print("=" * 60)
    print(f"  {'Aging & Geriatric Medicine'}")
