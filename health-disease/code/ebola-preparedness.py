#!/usr/bin/env python3
"""
Ebola Preparedness Audit — Africa E156 Student Analysis
Group: health-disease | Paper #40

Condition: Ebola OR Marburg OR viral hemorrhagic fever
Location: Africa

This standalone script demonstrates the statistical methods used in this paper.
Run: python ebola-preparedness.py
"""
...
def fetch_trial_count(condition=None, location=None, other=None):
    ...
    params["query.cond"] = "Ebola OR Marburg OR viral hemorrhagic fever"
...
def main():
    print("=" * 60)
    print(f"  {'Ebola Preparedness Audit'}")
