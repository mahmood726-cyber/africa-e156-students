#!/usr/bin/env python3
"""
Snake Envenomation Silence — Africa E156 Student Analysis
Group: health-disease | Paper #39

Condition: snakebite OR snake envenomation OR antivenom
Location: Africa

This standalone script demonstrates the statistical methods used in this paper.
Run: python snake-envenomation.py
"""
...
def fetch_trial_count(condition=None, location=None, other=None):
    ...
    params["query.cond"] = "snakebite OR snake envenomation OR antivenom"
...
def main():
    print("=" * 60)
    print(f"  {'Snake Envenomation Silence'}")
