#!/usr/bin/env python3
"""
Preterm Birth Interventions — Africa E156 Student Analysis
Group: health-disease | Paper #56

Condition: preterm birth OR prematurity OR NICU
Location: Africa

This standalone script demonstrates the statistical methods used in this paper.
Run: python preterm-birth.py
"""
...
def fetch_trial_count(condition=None, location=None, other=None):
    ...
    params["query.cond"] = "preterm birth OR prematurity OR NICU"
...
def main():
    print("=" * 60)
    print(f"  {'Preterm Birth Interventions'}")
