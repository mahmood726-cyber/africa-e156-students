#!/usr/bin/env python3
"""
Palliative Care Desert — Africa E156 Student Analysis
Group: health-disease | Paper #58

Condition: palliative care OR end of life OR hospice
Location: Africa

This standalone script demonstrates the statistical methods used in this paper.
Run: python palliative-care-desert.py
"""
...
def fetch_trial_count(condition=None, location=None, other=None):
    ...
    params["query.cond"] = "palliative care OR end of life OR hospice"
...
def main():
    print("=" * 60)
    print(f"  {'Palliative Care Desert'}")
