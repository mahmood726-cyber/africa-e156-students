#!/usr/bin/env python3
"""
Trypanosomiasis Last Mile — Africa E156 Student Analysis
Group: health-disease | Paper #37

Condition: trypanosomiasis OR sleeping sickness
Location: Africa

This standalone script demonstrates the statistical methods used in this paper.
Run: python trypanosomiasis-last-mile.py
"""
...
def fetch_trial_count(condition=None, location=None, other=None):
    ...
    params["query.cond"] = "trypanosomiasis OR sleeping sickness"
...
def main():
    print("=" * 60)
    print(f"  {'Trypanosomiasis Last Mile'}")
