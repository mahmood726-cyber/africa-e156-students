#!/usr/bin/env python3
"""
Sickle Cell Disease Neglect — Africa E156 Student Analysis
Group: health-disease | Paper #24

Condition: sickle cell disease
Location: Africa

This standalone script demonstrates the statistical methods used in this paper.
Run: python sickle-cell-neglect.py
"""
...
def fetch_trial_count(condition=None, location=None, other=None):
    ...
    params["query.cond"] = "sickle cell disease"
...
def main():
    print("=" * 60)
    print(f"  {'Sickle Cell Disease Neglect'}")
