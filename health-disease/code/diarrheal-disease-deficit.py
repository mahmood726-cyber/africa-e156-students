#!/usr/bin/env python3
"""
Diarrheal Disease Research Deficit — Africa E156 Student Analysis
Group: health-disease | Paper #45

Condition: diarrhea OR cholera OR rotavirus
Location: Africa

This standalone script demonstrates the statistical methods used in this paper.
Run: python diarrheal-disease-deficit.py
"""
...
def fetch_trial_count(condition=None, location=None, other=None):
    ...
    params["query.cond"] = "diarrhea OR cholera OR rotavirus"
...
def main():
    print("=" * 60)
    print(f"  {'Diarrheal Disease Research Deficit'}")
